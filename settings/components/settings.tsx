...
import { SpeakAIChatIntelligence, CustomLLMChatIntelligence, FreeTrialChatIntelligence, getSelectableChatIntelligenceSettings, getChatIntelligenceSettingsByID, OpenAIChatIntelligence } from "@/app/intelligence-llm/lib/intelligence";
import { InputHandler } from "@/app/chat/components/input-handlers";
import { SpeakAIChatISettings, CustomLLMChatISettings, FreeTrialChatISettings, OpenAIChatISettings } from "@/app/intelligence-llm/components/intelligence";
...
function CommonChatSettings({ chatSettings, updateChatSettings, className = "" }:
    ...
    return <div className={`flex flex-col pl-8 ${className}`}>
        ...
        {chatSettingsRO.chatISettings.chatIType === SpeakAIChatIntelligence.type &&
            <div className="flex flex-col mb-4">
                <SpeakAIChatISettings settings={chatSettingsRO.chatISettings.settings}
                    updateChatISettings={updateSelectedChatISettings} />
            </div>
        }
