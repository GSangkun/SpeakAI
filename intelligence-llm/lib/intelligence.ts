...
import { SpeakAIMessage, FreeTrialMessage, SpecialRoles, StreamingTextMessage } from "@/app/chat/components/message"
...
export function getSelectableChatIntelligenceSettings(): chatIntelligenceSettingsRecord[] {
    return getBuiltInChatIntelligenceSettings().concat(getCustomLLMChatISettings()).concat([speakAISettings])
}
...
// SpeakAI intelligence (just for fun :D)
export class SpeakAIChatIntelligence extends ChatIntelligenceBase {
    static readonly id = 'speak_ai'
    static readonly type = 'speak_ai'

    constructor() {
        super(SpeakAIChatIntelligence.type, { text: 'SpeakAI' })
    }

    completeChat(): Message[] {
        return [new SpeakAIMessage(SpecialRoles.ASSISTANT)]
    }
    ...
    static deserialize(): SpeakAIChatIntelligence {
        return new SpeakAIChatIntelligence()
    }
}
...
intelligenceRegistry.registerChatIntelligenceSerializer(SpeakAIChatIntelligence.type, SpeakAIChatIntelligence.deserialize);
...
const speakAISettings = {
    id: SpeakAIChatIntelligence.id,
    name: { key: 'SpeakAI' },
    type: SpeakAIChatIntelligence.type,
    settings: {}
}
