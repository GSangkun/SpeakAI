...
import { SpeakAIChatIntelligence, ChatIntelligence, CustomLLMChatIntelligence, CustomLLMServiceChatISettings, FreeTrialChatIntelligence, getChatIntelligenceSettingsByID, OpenAIChatIntelligence, OpenAIChatISettings, TutorialChatIntelligence } from "@/app/intelligence-llm/lib/intelligence";
...
export function Chat({ chatID, chatTitle, loadChatByID, className = "" }: {
    ...
    if (chatSettings !== undefined) {
        ...
        } else if (type === SpeakAIChatIntelligence.type) {
            chatIntelligence = new SpeakAIChatIntelligence()
