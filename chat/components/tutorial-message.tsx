    ...
    contentNode() {
        const Root = () => {
            ...
            if (this.currentStateID === TutorialStateIDs.introduction) {
                const content = t("SpeakAI 面向不同英语水平的学习者，提供沉浸式、AI驱动的口语对话练习平台。区别于常见的 AI 聊天工具，结合语言学习特点，设计了一套多模态、多功能的辅助模块。本教程将为你简单介绍如何使用该系统。若你更倾向于自行摸索，可以点击左下角「新建对话」，即可开始体验，之后你依然随时可以回来继续该教程。")
            ...
            if (this.currentStateID === TutorialStateIDs.clickNextToIllustrateGrammarCheck) {
                const paragraph1 = t("以上便是 SpeakAI 中其中一个快捷指令的基本使用流程，除此之外，我们还提供了其他一系列快捷指令。")
