        ...
        resources: {
            en: {
                translation: {
                    ...
                    'Welcome to SpeakAI': 'Welcome to SpeakAI',
                    ...
                    'welcomeMessage': 'SpeakAI is an AI-powered conversation practice application for language learners of all proficiency levels',
                    ...
                    '摄像头': 'Camera',
                    '无法访问摄像头，请确保您已授予摄像头权限': 'Cannot access camera. Please make sure you have granted camera permissions.',
                    '正在加载摄像头...': 'Loading camera...',
                    '识别结果:': 'Recognition Result:',
                    '拍照并识别': 'Capture & Recognize',
                    '正在识别...': 'Recognizing...',
                    '关闭': 'Close',
                    '这是一张照片，实际项目中可以接入图像识别API': 'This is a photo. In the actual project, you can integrate with image recognition APIs.',
                    'Azure 计算机视觉 API 配置': 'Azure Computer Vision API Configuration',
                    '请先配置 Azure 计算机视觉 API 密钥和端点才能使用图像识别功能。': 'Please configure your Azure Computer Vision API key and endpoint to use image recognition features.',
                    'API 端点': 'API Endpoint',
                    'API 密钥': 'API Key',
                    '请输入 Azure 计算机视觉 API 密钥': 'Enter your Azure Computer Vision API key',
                    '保存配置': 'Save Configuration',
                    'Azure 计算机视觉 API 配置已保存': 'Azure Computer Vision API configuration has been saved',
                    '请在设置中配置 Azure 计算机视觉 API 密钥和端点': 'Please configure Azure Computer Vision API key and endpoint in settings',
                    '图像处理失败，请稍后重试': 'Image processing failed, please try again later',
                    '图像转换失败，请重试': 'Image conversion failed, please try again',
                    '图像识别失败': 'Image recognition failed',
                    'API 调用失败': 'API call failed',
                    '图像识别失败，请确保 Azure 计算机视觉 API 配置正确': 'Image recognition failed, please make sure your Azure Computer Vision API configuration is correct',
                    '数字人对话': 'Digital Human',
                    '选择数字人模型': 'Select Digital Human Model',
                    'Mya (VRM)': 'Mya (VRM)',
                    'Qin (GLB)': 'Qin (GLB)',
                    '与数字人对话，输入文字让数字人说话。': 'Chat with the digital human. Enter text to make it speak.',
                    '请输入要数字人说的话...': 'Enter text for the digital human to speak...',
                    '生成语音': 'Generate Speech',
                    '正在说话...': 'Speaking...',
                    '使用 Azure TTS 提供语音服务': 'Powered by Azure TTS service',
                    // tutorials
                    ...
                    "BabelDuck 是一款面向各水平层次语言学习者的 AI 口语对话练习应用。除了普通的 AI 对话聊天能力外，我们还提供了一系列为口语练习场景而设计的工具，本教程将为你简单介绍如何使用它们。若你更倾向于自行摸索，可以点击左下角「新建对话」，即可开始体验，之后你依然随时可以回来继续该教程。": "SpeakAI is an AI conversation practice application designed for language learners of all proficiency levels. In addition to regular AI chat capabilities, we provide a suite of tools specifically designed for oral practice scenarios. This tutorial will briefly introduce how to use them. If you prefer to explore on your own, you can click the 'New Chat' button in the lower left corner to start experiencing it, and you can always come back to this tutorial later.",
                    "BabelDuck 提供了一系列快捷指令，协助用户在口语表达上遇到困难时更流畅地推进对话。\n比如有些人练习初期很容易遇到\"卡壳\"的情况，完全不知道某句话该如何表达时，不得不切出去寻求其他工具的帮助。为此系统内置了一个快捷指令，作为初期过渡工具用，允许你先用母语表达一遍，然后帮你转换为对应语言。\n\n接下来我们简单演示下使用方法": "SpeakAI provides a series of shortcut commands to help users maintain conversation flow when they encounter difficulties in oral expression.\nFor example, some people in the early stages of practice easily experience \"getting stuck\", not knowing how to express a certain sentence, forcing them to seek help from other tools. For this purpose, the system has a built-in shortcut command as an initial transition tool, allowing you to first express yourself in your native language, then helping you convert it to the corresponding language.\n\nLet's briefly demonstrate how to use it",
                    "在子对话中，你可以在当前对话的基础上，向 AI 追问更多问题。": "In sub-conversations, you can ask AI follow-up questions based on the current conversation.",
                    "以上便是 BabelDuck 中其中一个快捷指令的基本使用流程，除此之外，我们还提供了其他一系列快捷指令。": "Above is the basic usage process of one of SpeakAI's shortcut commands. Besides this, we provide several other shortcut commands.",
                    ...
                    '识别到的物体': 'Detected Objects',
                    '相关标签': 'Related Tags',
                    '使用 Azure 计算机视觉 API 提供图像识别服务': 'Using Azure Computer Vision API for image recognition services',
                    
                    '智谱AI数字人对话': 'Zhipu AI Digital Human',
                    '智谱AI数字人': 'Zhipu AI Digital Human',
                    '与智谱AI数字人对话，输入文字或上传图片。': 'Chat with Zhipu AI Digital Human, enter text or upload images.',
                    '数字人会分析图像内容并提供语音回复。': 'The digital human will analyze image content and provide voice responses.',
                    '思考中...': 'Thinking...',
                    '发送': 'Send',
                    '上传图片': 'Upload Image',
                    '上传中...': 'Uploading...',
                    '上传图片进行识别': 'Upload image for recognition',
                    '使用智谱GLM-4大模型提供语义理解，Azure TTS提供语音服务': 'Powered by Zhipu GLM-4 for semantic understanding and Azure TTS for voice services',
                    '3D模式': '3D Mode',
                    '2D模式': '2D Mode',
                    '图像识别失败，请确保 Azure 计算机视觉 API 配置正确': 'Image recognition failed, please make sure your Azure Computer Vision API configuration is correct',
                    'API 调用失败': 'API call failed',
                    '使用GLM-4-Flash模型提供语义理解，支持实时对话': 'Using GLM-4-Flash model for semantic understanding, supporting real-time conversation',
                    
                    '视频对话': 'Video Chat',
                    'GLM-Realtime视频对话': 'GLM-Realtime Video Chat',
                    '已连接': 'Connected',
                    '等待连接GLM-Realtime...': 'Waiting to connect to GLM-Realtime...',
                    '连接中...': 'Connecting...',
                    '开始视频对话': 'Start Video Chat',
                    '关闭麦克风': 'Mute Microphone',
                    '开启麦克风': 'Unmute Microphone',
                    '关闭摄像头': 'Turn Off Camera',
                    '开启摄像头': 'Turn On Camera',
                    '停止屏幕共享': 'Stop Screen Sharing',
                    '开始屏幕共享': 'Start Screen Sharing',
                    '对话开始，请发送消息...': 'Chat started, send a message...',
                    '连接后开始对话': 'Connect to start chatting',
                    '发送消息...': 'Send message...',
                    '请先连接...': 'Please connect first...',
                    '发送': 'Send',
                    '连接错误，请稍后重试': 'Connection error, please try again later',
                    '连接已断开，请刷新页面重试': 'Connection lost, please refresh the page to retry',
                    '连接失败': 'Connection failed',
                    '屏幕共享失败，请重试': 'Screen sharing failed, please try again',
                    '无法访问摄像头或麦克风，请确保您已授予权限': 'Cannot access camera or microphone, please make sure you have granted permissions',
                    '连接超时，请重试': 'Connection timeout, please try again',
                    
                    // GLM-4-Flash对话
                    'GLM-4-Flash对话': 'GLM-4-Flash Chat',
                    'GLM-4-Flash模型对话': 'GLM-4-Flash Model Chat',
                    '使用智谱AI最新的免费模型，支持128K上下文和4K输出。适用于问答、摘要和文本处理等场景。': 'Using Zhipu AI\'s latest free model, supporting 128K context and 4K output. Suitable for Q&A, summarization, and text processing.',
                    '开始对话': 'Start Chat',
                    '输入消息...': 'Type message...',
            ...
            zh: {
                translation: {
                    ...
                    'Welcome to SpeakAI': '欢迎使用 SpeakAI',
                    ...
                    'welcomeMessage': 'SpeakAI 是一款面向各水平层次语言学习者的 AI 口语对话练习应用',
                    ...
                    'speakAIChatIntelligenceIntroduction': '基于先进的禽类神经仿生学架构，这套革命性的水禽智能系统采用独特的鸭子认知模式，具备先进的多语言处理能力，可实现毫秒级响应速度。',
                    'Blur Text': '模糊文本',
                    ...
                    "BabelDuck 是一款面向各水平层次语言学习者的 AI 口语对话练习应用。除了普通的 AI 对话聊天能力外，我们还提供了一系列为口语练习场景而设计的工具，本教程将为你简单介绍如何使用它们。若你更倾向于自行摸索，可以点击左下角「新建对话」，即可开始体验，之后你依然随时可以回来继续该教程。": "SpeakAI 是一款 AI 口语对话练习应用，在这个基础上我们还提供了一系列口语练习辅助工具，本教程将为你简单介绍如何使用它们。\n或者你也可以直接点击左下角「新建对话」，直接开始体验。",
                    "BabelDuck 提供了一系列快捷指令，协助用户在口语表达上遇到困难时更流畅地推进对话。\n比如有些人练习初期很容易遇到\"卡壳\"的情况，完全不知道某句话该如何表达时，不得不切出去寻求其他工具的帮助。为此系统内置了一个快捷指令，作为初期过渡工具用，允许你先用母语表达一遍，然后帮你转换为对应语言。\n\n接下来我们简单演示下使用方法": "SpeakAI 提供了一系列快捷指令，协助用户在口语表达上遇到困难时更流畅地推进对话。\n\n接下来我们简单演示下使用方法。",
                    ...
                    '识别到的物体': '识别到的物体',
                    '相关标签': '相关标签',
                    '使用 Azure 计算机视觉 API 提供图像识别服务': '使用 Azure 计算机视觉 API 提供图像识别服务',
            ...
            ja: {
                translation: {
                    ...
                    'Welcome to SpeakAI': 'SpeakAI へようこそ',
                    ...
                    'Quack!': 'ガー！',
                    'freeTrialHintMessage': '現在のチャットモデルサービスは、速度と用頻度の制限があります。設定ページ「チャット -> チャットモデルサービス」から他のモデルサービスに切り替えてください。',
                    'welcomeMessage': 'SpeakAI は、全ての習熟度レベルの言語学習者のためのAI会話練習アプリケーションです',
                    'Please enter the complete URL including the path': 'パスを含む完全なURLを入力してください',
                    'freeTrialChatIntelligenceIntroduction': '新規ユーザー向けのクイック体験用サービスで、速度と利用頻度に制限があります。必要な場合は、他のモデルサービスに切り替えてください。',
                    'speakAIChatIntelligenceIntroduction': '先進的な鳥類神経生体模倣アーキテクチャに基づき、この革新的な水禽智能システムは独自のアヒル認知パターンを採用し、高度な多言語処理能力とミリ秒レベルの応答速度を実現します。',
                    'Blur Text': 'テキストをぼかす',
